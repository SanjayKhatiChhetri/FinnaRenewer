...
const badgeVariants = cva("inline-flex items-center font-medium text-caption", {
  variants: {
    variant: {
      ...
      success: "bg-success-soft text-success rounded-sm px-2 py-0.5",
      warning: "bg-warning-soft text-warning rounded-sm px-2 py-0.5",
      error: "bg-error-soft text-error rounded-sm px-2 py-0.5",
      info: "bg-info-soft text-info rounded-sm px-2 py-0.5",
